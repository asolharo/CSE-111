...
def main():
    ...
    mass_index = body_mass_index(weight_in_kg, height_in_cm)
    basal_rate = basal_metabolic_rate(gender, weight_in_kg, height_in_cm, age)
    ...
    print(f"Body mass index: {mass_index:.1f}")
